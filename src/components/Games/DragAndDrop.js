      ...
      <View style={styles.aheader}>
        <View>
          ...
          <Text style={styles.aheader_desc}>
            This is going to be about ordering, all you have to do is
            order the following panels in the correct order, below you have a check answer
            button which can help you determine if your answer is correct or not.
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: '#2b2d40' }}>
        ...
        <TouchableOpacity style={{
          ...
          padding: 10
        }} onPress={() => { this.checkAnswer(this.state.newAnswer) }}>
